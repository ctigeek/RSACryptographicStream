    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                //Magic!
                Encrypt(source, destination, rsaKey);
                ...
                //more Magic!
                Decrypt(destination, decryptedData, rsaKey);
        ...
        private static void Encrypt(Stream source, Stream destination, RSACryptoServiceProvider key)
        {
        ...
        private static void Decrypt(Stream source, Stream destination, RSACryptoServiceProvider key)
        {
